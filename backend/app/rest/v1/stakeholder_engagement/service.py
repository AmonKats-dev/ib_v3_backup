...
from .model import StakeholderEngagement
from .resource import StakeholderEngagementList, StakeholderEngagementView
from .schema import StakeholderEngagementSchema


class StakeholderEngagementService(BaseService):
    def __init__(self, **kwargs):
        super().__init__()
        self.model = StakeholderEngagement
        self.schema = StakeholderEngagementSchema
        self.resources = [
            {'resource': StakeholderEngagementList,
                'url': '/stakeholder-engagements'},
            {'resource': StakeholderEngagementView,
                'url': '/stakeholder-engagements/<int:record_id>'}
        ]
