...
from .model import ExecutingAgency
from .resource import ExecutingAgencyList
from .schema import ExecutingAgencySchema


class ExecutingAgencyService(BaseService):
    def __init__(self, **kwargs):
        super().__init__()
        self.model = ExecutingAgency
        self.schema = ExecutingAgencySchema
        self.resources = [
            {'resource': ExecutingAgencyList, 'url': '/executing-agencies'}
        ]
    ...
    def manage_executing_agencies(self, records, project_detail_id, delete=False):
        if delete:
            ids = []
...
def update_executing_agency(self, project_detail, **kwargs):
    records = kwargs.get("executing_agencies", None)
    if records is not None:
        service = ExecutingAgencyService()
        service.manage_executing_agencies(
