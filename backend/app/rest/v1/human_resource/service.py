...
from .model import HumanResource
from .resource import HumanResourceList, HumanResourceView
from .schema import HumanResourceSchema


class HumanResourceService(BaseService):
    def __init__(self, **kwargs):
        super().__init__()
        self.model = HumanResource
        self.schema = HumanResourceSchema
        self.resources = [
            {'resource': HumanResourceList, 'url': '/human-resources'},
            {'resource': HumanResourceView,
                'url': '/human-resources/<int:record_id>'}
        ]
